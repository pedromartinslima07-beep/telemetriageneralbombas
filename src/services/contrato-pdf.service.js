...
function renderHTML(ct) {
  ...
  const formaStr  = { boleto:"boleto bancário", pix:"PIX", transferencia:"transferência bancária", cartao:"cartão", outro:"a definir" }[ct.forma_pagamento] || "a definir";
  const descServ  = escHtml(ct.descricao_servico || "Manutenção preventiva e corretiva das motobombas hidráulicas e seus sistemas de automatização e abastecimento.");
...
<div class="doc-header">
  ...
  <div class="doc-numero">Contrato Nº ${numero}</div>
  <div class="doc-data">São Paulo, ${dataDoc}</div>
</div>
...
<div class="clausula">
  ...
  <p><strong>1.1</strong> – Prestar serviços de manutenção preventiva e corretiva com mão de obra especializada ao "CONTRATANTE", no que tange à conservação das motobombas hidráulicas e seus sistemas de automatizações e abastecimentos.</p>
...
<div class="clausula">
  ...
  <p><strong>2.1.4</strong> – <span class="destaque">Os serviços descritos neste contrato não abrangem cobertura de peças. Em casos de queima de equipamento, a reposição e reparo são de responsabilidade do CONTRATANTE, com custo adicional, mediante orçamento prévio e aprovação do condomínio.</span></p>
...
<div class="clausula">
  <div class="clausula-titulo">Cláusula Terceira – Obrigações e Responsabilidades da CONTRATANTE</div>
  ...
  <p><strong>3.4</strong> – O contrato não cobre as peças relacionadas ao complexo de Bombas. <span class="destaque">Todos os itens que não sejam mecanismo/maquinário das bombas serão orçados com prévio aviso e consentimento do condomínio.</span></p>
</div>
...
<div class="clausula">
  ...
  <p><strong>9.5</strong> – A CONTRATADA assumirá, em seu nome, as responsabilidades por todas as transações comerciais contraídas em decorrência da execução dos serviços.</p>
  <p><strong>9.6</strong> – As disposições deste contrato poderão ser alteradas apenas mediante celebração de termo aditivo.</p>
  <p><strong>9.7</strong> – A CONTRATADA declara estar devidamente habilitada, legal e tecnicamente, a firmar e executar o presente contrato.</p>
  <p><strong>9.8</strong> – As partes declaram que cumprirão integralmente a <strong>Lei Geral de Proteção de Dados (LGPD – Lei Federal nº 13.709/2018)</strong> e todas as demais leis e regulamentos aplicáveis ao tratamento de dados pessoais.</p>
  <p><strong>9.9</strong> – O presente instrumento constitui a integralidade dos entendimentos entre as Partes sobre os assuntos aqui previstos, revogando todo e qualquer ajuste, acordo ou correspondência anterior.</p>
</div>

<div class="clausula">
  <div class="clausula-titulo">Cláusula Décima – Das Penalidades</div>
  <p><strong>10.1</strong> – O descumprimento de quaisquer cláusulas contratuais acarretará multa equivalente a <strong>2% (dois por cento) do valor anual do contrato</strong>, se a parte infratora, após notificada, não adimplir com sua obrigação em 10 (dez) dias, sem prejuízo de eventual indenização por perdas e danos.</p>
