/*! jsQR 1.4.0 — github.com/cozmo/jsQR — Apache-2.0
    Leitor de QR do painel do técnico (/tecnico/painel), usado SÓ onde o
    `BarcodeDetector` nativo não existe (Safari, Firefox, Chrome de Windows).
    Vendorizado como o leaflet.js e o apexcharts.min.js: a CSP do helmet é
    `script-src 'self'` e script de CDN não executa aqui.
    Origem: node_modules/jsqr@1.4.0/dist/jsQR.js, minificado com terser 5.31.
    Não editar à mão — regerar a partir do pacote. */
