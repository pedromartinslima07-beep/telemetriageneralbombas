...
| POST | `/admin/orcamentos/avulsos/:id/resposta-vista` | marca que alguem do escritorio abriu a resposta do cliente — apaga o aviso da aba. Idempotente: nao reescreve a data da primeira vez |
